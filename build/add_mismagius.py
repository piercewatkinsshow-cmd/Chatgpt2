...
# This old fork defines the selector in custom_starter/custom_starter_menu.asm
# with a single colon. The follow-up compatibility script wraps that label.
raise SystemExit("Selector wrapper handled by fix_mismagius_selector.py")
